    ...
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 rounded-lg bg-white border border-gray-200 hover:border-[#9a5bff]/40 hover:bg-[#9a5bff]/5 flex items-center justify-center text-gray-400 hover:text-[#9a5bff] transition-all duration-200">
        ...
        <div className="border-t border-gray-200 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-gray-400 text-sm">© 2024 Memon Mobile Zone. All rights reserved.</p>
